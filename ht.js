...
Date: 2026-08-17；适配 2026-08-21；v3增强 2026-08-28
Desc:
...
Surge:
  [Script]
  http-response ^https?://(cmallapi\.xkmm\.cn|cmallapi\.haday\.cn)/buyer-api/(wechat/mini/(login|phoneNew/login)(?:[?/]|$)|members(?!/)|pages/params(?:[?/]|$)|sign/activity/code(?:[?/]|$)|sign/activity/quiz/today(?:[?/]|$)|sign/activity/member/info) script-path=https://xxx/ht.js, requires-body=true
  [MITM]
  hostname = %APPEND% cmallapi.xkmm.cn, cmallapi.haday.cn
QuantumultX:
  [rewrite_local]
  ^https?://(cmallapi\.xkmm\.cn|cmallapi\.haday\.cn)/buyer-api/(wechat/mini/(login|phoneNew/login)(?:[?/]|$)|members(?!/)|pages/params(?:[?/]|$)|sign/activity/code(?:[?/]|$)|sign/activity/quiz/today(?:[?/]|$)|sign/activity/member/info) url script-response-body https://xxx/ht.js
  [mitm]
...
Shadowrocket:
  [Script]
  http-response ^https?://(cmallapi\.xkmm\.cn|cmallapi\.haday\.cn)/buyer-api/(wechat/mini/(login|phoneNew/login)(?:[?/]|$)|members(?!/)|pages/params(?:[?/]|$)|sign/activity/code(?:[?/]|$)|sign/activity/quiz/today(?:[?/]|$)|sign/activity/member/info) script-path=https://xxx/ht.js, requires-body=true, max-size=0
  [MITM]
  hostname = cmallapi.xkmm.cn, cmallapi.haday.cn
